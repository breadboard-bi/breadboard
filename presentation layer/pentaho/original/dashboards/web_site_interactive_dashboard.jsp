...
try {
   ...
   //now get the third query results, String sql_sys
...
report_title = "Top Visits for the " + temporal_cat + " " + temporal_value;
...
parameters.setParameter( "drill-url", "web_site_interactive_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value={SERIES}" );
...
// define the click url template
// parameters.setParameter( "drill-url", "web_site_interactive_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value="+temporal_value+"&amp;country={SERIES}" );
// define the bars of the bar chart
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
parameters.setParameter( "HOSTED_CLIENT_SK", hosted_client_sk);
parameters.setParameter( "SOURCE_SYSTEM_SK", source_system_sk);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_visit_period_country_vert_bar.widget.xml", parameters, content_2, 
					 userSession, messages, null ); 
...
SolutionHelper.doAction( "breadboard", "customer_360/web_analytics/dashboards/report", 
					   "web_page_top_report.xaction", "web_visit_interactive_dashboard_5.jsp", 
...
<form name="form1" action="web_site_interactive_dashboard.jsp" method="GET">
