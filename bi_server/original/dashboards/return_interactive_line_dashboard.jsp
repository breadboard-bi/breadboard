...
if (category.length() > 0) {
   title = "Returns by " + temporal_value + " and " + country + " and " + category;
   report_title = "Top Returned Products by " + temporal_value + " and " + country + " and " + category;
   dial_title = "Period Return Trends for " + country + " and " + category;
} else if ( country.length() > 0)  {
   title = "Returns by " + temporal_value + " and " + country;
   report_title = "Top Products by " + temporal_value + " and " + country;
   dial_title = "Period Return Trends for " + temporal_value + " and " + country;
...
if (temporal_cat == "Year of " || temporal_cat == "Quarter of ") {
   ...
   parameters.setParameter( "drill-url", "return_interactive_line_dashboard.jsp?temporal_value={SERIES}" );
}
...
//define the click url template
parameters.setParameter("drill-url", "return_interactive_line_dashboard.jsp?temporal_value="
...
ChartHelper.doChart("breadboard", "customer_360/returns/dashboards",
                    "return_period_country_vert_bar.widget.xml", parameters,
...
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "return_interactive_line_dashboard.jsp?temporal_value="+temporal_value
...
//use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart("breadboard", "customer_360/returns/dashboards",
                    "return_period_country_pcat_vert_bar.widget.xml", parameters,
...
SolutionHelper.doAction("breadboard", "customer_360/returns/dashboards/reports",
                     "return_top_products_report.xaction", "return_interactive_line_dashboard.jsp",
...
// use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart( "breadboard", "customer_360/returns/dashboards", 
					  "return_period_country_pcat_line.widget.xml", parameters, 
...
<form name="form1" action="return_interactive_line_dashboard.jsp" method="GET">
