...
title  = "Paid Keyword Search & Content Visits for the " + temporal_cat+" "+temporal_value;
click_instructions="Click the Content Page to see additional details.";
report_title = "Top Paid Content Referrals for the " + temporal_cat+" "+temporal_value;
...
// Make a bar chart showing the referrals by period.
// create the parameters for the bar chart
SimpleParameterProvider parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "web_syndication_interactive_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value={SERIES}" );
...
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "syndication_web_visit_period_vert_bar.widget.xml", parameters, 
					 content_1, userSession, messages, null); 





// Make a bar chart showing the top syndication referers
// create the parameres for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
// parameters.setParameter( "drill-url", "web_syndication_interactive_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value="+temporal_value+"&amp;keyword={SERIES}" );
...
// call the chart helper to generate the bar chart image and to get the HTML content
// use the chart definition in 'samples/customer_360/web_analytics/dashboards/regions.widget.xml'
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "syndication_by_period_vert_bar.widget.xml", parameters, 
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "keyword_paid_by_period_vert_bar.widget.xml", parameters, content_3, 
...
SolutionHelper.doAction( "breadboard", "customer_360/web_analytics/dashboards/report", 
					  "syndication_referer_report.xaction", 
					  "web_syndication_interactive_dashboard.jsp", parameters, 
...
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "keyword_referer_by_period_line.widget.xml", parameters, content_4, 
					 userSession, messages, null ); 				 
...
<form name="form1" action="web_syndication_interactive_dashboard.jsp" method="GET">
...
<BR>
<!-- Top of #4 -->
<small><%= click_instructions %></small>
                        <%= report_1.toString() %>
<!-- BOTTOM 4 -->
                </td>
