...
String dashboard_title = "Accounts Payable Dashboard";
...
parameters.setParameter( "drill-url", "ap_hybrid_dashboard.jsp?temporal_value={SERIES}" );
}
...
ChartHelper.doChart( "breadboard", "finance/account_payable/dashboards", 
					"ap_period_vert_bar.widget.xml", parameters, 
...
// define the click url template
parameters.setParameter( "drill-url", "ap_hybrid_dashboard.jsp?temporal_value="+temporal_value+"&amp;account_type={SERIES}" );
// define the bars of the bar chart
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "finance/account_payable/dashboards",
 					"ap_period_account_type_vert_bar.widget.xml", parameters, 
...
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "ap_hybrid_dashboard.jsp?temporal_value="+temporal_value+"&amp;account_type="+account_type+"&amp;bu_type={SERIES}" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "finance/account_payable/dashboards", 
					"ap_period_account_type_bu_type_vert_bar.widget.xml", parameters, 
...
ChartHelper.doChart( "breadboard", "finance/account_payable/dashboards", 
				"ap_period_account_type_bu_type_line.widget.xml", parameters, 
...
ChartHelper.doChart( "breadboard", "finance/account_payable/dashboards",
 			"ap_period_account_type_bu_type_line_II.widget.xml", parameters, 
...
<html>
<head>
<title>Breadboard BI Sample Accounts Payable Dashboard</title>
...
<form name="form1" action="ap_hybrid_dashboard.jsp" method="GET">
...
<!-- Top of #4 -->
<BR>
<a href="Pivot?solution=breadboard&path=finance/account_payable/analysis&action=ap_time_trend_cube.xaction" target="_blank">
