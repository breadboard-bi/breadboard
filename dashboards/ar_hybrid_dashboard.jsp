...
String dashboard_title = "Accounts Receivable Dashboard";
...
if (temporal_value.indexOf("W") >= 0) {
   ...
   sql  = "SELECT "+
          ...
          "WHERE "+
          "WEEK_NAME = ?";
   sql3 = "select ROUND(AVG(F.TRXN_RECEIVABLE_AMT)) as AVG_TRXN_AMT FROM FACT_ACCOUNT_RECEIVABLE F, DIMENSION_ACCOUNT A, DIMENSION_DAY D, DIMENSION_BUSINESS_UNIT B WHERE D.WEEK_NAME = ? AND A.ACCOUNT_TYPE_DESC = ? AND B.BUSINESS_UNIT_TYPE_NAME = ? AND F.ACCOUNT_SK = A.ACCOUNT_SK AND F.JOURNAL_DATE_SK = D.DATE_SK AND F.BUSINESS_UNIT_SK = B.BUSINESS_UNIT_SK";
   ...
   sql  = "SELECT "+
          ...
          "WHERE "+
          "YEAR_QUARTER_NAME = ?";
   sql3 = "select ROUND(AVG(F.TRXN_RECEIVABLE_AMT)) as AVG_TRXN_AMT FROM FACT_ACCOUNT_RECEIVABLE F, DIMENSION_ACCOUNT A, DIMENSION_DAY D, DIMENSION_BUSINESS_UNIT B WHERE D.YEAR_QUARTER_NAME = ? AND A.ACCOUNT_TYPE_DESC = ? AND B.BUSINESS_UNIT_TYPE_NAME = ? AND F.ACCOUNT_SK = A.ACCOUNT_SK AND F.JOURNAL_DATE_SK = D.DATE_SK AND F.BUSINESS_UNIT_SK = B.BUSINESS_UNIT_SK";
   ...
   sql3 = "select ROUND(AVG(F.TRXN_RECEIVABLE_AMT)) as AVG_TRXN_AMT FROM FACT_ACCOUNT_RECEIVABLE F, DIMENSION_ACCOUNT A, DIMENSION_DAY D, DIMENSION_BUSINESS_UNIT B WHERE D.MONTH_SK = ? AND A.ACCOUNT_TYPE_DESC = ? AND B.BUSINESS_UNIT_TYPE_NAME = ? AND F.ACCOUNT_SK = A.ACCOUNT_SK AND F.JOURNAL_DATE_SK = D.DATE_SK AND F.BUSINESS_UNIT_SK = B.BUSINESS_UNIT_SK";
   ...
   sql  = "SELECT "+
          ...
          "WHERE "+
          "YEAR_SK = ?";
   sql3 = "select ROUND(AVG(F.TRXN_RECEIVABLE_AMT)) as AVG_TRXN_AMT FROM FACT_ACCOUNT_RECEIVABLE F, DIMENSION_ACCOUNT A, DIMENSION_DAY D, DIMENSION_BUSINESS_UNIT B WHERE D.YEAR_SK = ? AND A.ACCOUNT_TYPE_DESC = ? AND B.BUSINESS_UNIT_TYPE_NAME = ? AND F.ACCOUNT_SK = A.ACCOUNT_SK AND F.JOURNAL_DATE_SK = D.DATE_SK AND F.BUSINESS_UNIT_SK = B.BUSINESS_UNIT_SK";
   ...
   sql3 = "select ROUND(AVG(F.TRXN_RECEIVABLE_AMT)) as AVG_TRXN_AMT FROM FACT_ACCOUNT_RECEIVABLE F, DIMENSION_ACCOUNT A, DIMENSION_DAY D, DIMENSION_BUSINESS_UNIT B WHERE D.DATE_SK = ? AND A.ACCOUNT_TYPE_DESC = ? AND B.BUSINESS_UNIT_TYPE_NAME = ? AND F.ACCOUNT_SK = A.ACCOUNT_SK AND F.JOURNAL_DATE_SK = D.DATE_SK AND F.BUSINESS_UNIT_SK = B.BUSINESS_UNIT_SK";
} else {
   temporal_cat = "";
}
...
widget_2_title = "By the " + temporal_cat+" "+temporal_value +  " & " + account_type;
widget_3_title = "By the " + temporal_cat+" "+temporal_value +  " & " + account_type + " & " + bu_type;


trend_line_amt_title = "Open & Paid Amounts for the " + temporal_cat+" "+temporal_value + " & "  + account_type + " & " + bu_type;
trend_line_qty_title = "Discount, Discount Lost & Late Charges for the " + temporal_cat+" "+temporal_value + " & "  + account_type + " & " + bu_type; 
...
parameters.setParameter( "drill-url", "ar_hybrid_dashboard.jsp?temporal_value={SERIES}" );
}
...
ChartHelper.doChart( "breadboard", "finance/account_receivable/dashboards", 
					"ar_period_vert_bar.widget.xml", parameters, 
...
// define the click url template
parameters.setParameter( "drill-url", "ar_hybrid_dashboard.jsp?temporal_value="+temporal_value+"&amp;account_type={SERIES}" );
// define the bars of the bar chart
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "finance/account_receivable/dashboards",
 					"ar_period_account_type_vert_bar.widget.xml", parameters, 
...
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "ar_hybrid_dashboard.jsp?temporal_value="+temporal_value+"&amp;account_type="+account_type+"&amp;bu_type={SERIES}" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "finance/account_receivable/dashboards", 
					"ar_period_account_type_bu_type_vert_bar.widget.xml", parameters, 
...
ChartHelper.doChart( "breadboard", "finance/account_receivable/dashboards", 
				"ar_period_account_type_bu_type_line.widget.xml", parameters, 
...
ChartHelper.doChart( "breadboard", "finance/account_receivable/dashboards",
 			"ar_period_account_type_bu_type_line_II.widget.xml", parameters, 
...
<html>
<head>
<title>Breadboard BI Sample Accounts Receivable Dashboard</title>
...
<form name="form1" action="ar_hybrid_dashboard.jsp" method="GET">
...
<!-- Top #2 -->
<%= widget_2_title %><br>
<small>click on a bar to change the account type</small>
...
<td valign="top" style="width: 33%;font-family:Arial;font-weight:bold;">
<%= widget_3_title %><br>
<small>click on a bar to change the business unit</small>
