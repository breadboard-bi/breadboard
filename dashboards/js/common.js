...
function doSelObjLookUpAdd(selObj, val) {
   //if a unit was passed in need to select it from the drop down list
   var foundIt = false;
   ...
   if ( (foundIt == false) && (val.length > 0) ) {
           if (selObj.options[selObj.length - 1].value == "empty") {
          selObj.options[selObj.length - 1].value = val;
          selObj.options[selObj.length - 1].text = val;
              selObj.options[selObj.length - 1].selected = true;
              var newOption = new Option("{ENTER NEW VALUE}", "empty");
...
////////////////////////////////////////////////////////////////////
///////////Calendar Code/////////////////////////////////////////////
/////////this code also appears within the overlib javascript libraries
/////////be careful if you edit these functions
/* ********************************************************************
