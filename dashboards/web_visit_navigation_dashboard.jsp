...
title = "Page Navigation Overview for the " + temporal_cat + " " + temporal_value;
report_title = "Top Paths for the " + temporal_cat + " " + temporal_value;
...
// Make a bar chart showing the pages
// create the parameters for the bar chart
SimpleParameterProvider parameters = new SimpleParameterProvider();
// define the click url template
// parameters.setParameter( "drill-url", "web_visit_navigation_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value={SERIES}" );
...
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_view_period_page_top_vert_bar.widget.xml", parameters, 
					 content_1, userSession, messages, null); 




// Make a bar chart showing the top landing pages
// create the parameters for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
// parameters.setParameter("drill-url","web_visit_navigation_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_valuer="+temporal_value+"&amp;region={SERIES}" );
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_view_period_landing_page_top_vert_bar.widget.xml", parameters, 
					 content_2, userSession, messages, null ); 



// Make a bar chart showing the top exit pages 
// create the parameters for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					  "web_view_period_exit_page_top_vert_bar.widget.xml", parameters, 
...
SolutionHelper.doAction( "breadboard", "customer_360/web_analytics/dashboards/report", 
					   "web_visit_top_paths_report.xaction", 
					   "web_visit_navigation_dashboard_4.jsp", parameters, report_1 , 
...
<form name="form1" action="web_visit_navigation_dashboard.jsp" method="GET">
