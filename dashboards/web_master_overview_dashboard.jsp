...
// If null, this hardcodes to the parent sk for web logs.	
...
// Make a bar chart showing the web visits by period
// create the parameters for the bar chart
SimpleParameterProvider parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "web_master_overview_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value={SERIES}" );
...
// Make a bar chart showing the web browsers
// create the parameres for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
// parameters.setParameter( "drill-url", "web_master_overview_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value="+temporal_value+"&amp;country={SERIES}" );
// define the bars of the bar chart
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
parameters.setParameter( "HOSTED_CLIENT_SK", hosted_client_sk);
parameters.setParameter( "SOURCE_SYSTEM_SK", source_system_sk);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_browser_period_vert_bar.widget.xml", parameters, content_2, 
					 userSession, messages, null ); 
...
parameters = new SimpleParameterProvider();
// define the click url template
// parameters.setParameter("drill-url","web_master_overview_dashboard.jsp?source_system_sk="+source_system_sk+"&amp;temporal_value="+temporal_value+"&amp;country="+country+"&amp;region={SERIES}" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
parameters.setParameter( "HOSTED_CLIENT_SK", hosted_client_sk);
parameters.setParameter( "SOURCE_SYSTEM_SK", source_system_sk);
...
// call the chart helper to generate the bar chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_visit_period_referer_vert_bar.widget.xml", parameters, 
...
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_visit_period_line.widget.xml", parameters, content_4, 
					 userSession, messages, null ); 
...
// call the chart helper to generate the pie chart image and to get the HTML content
ChartHelper.doChart( "breadboard", "customer_360/web_analytics/dashboards", 
					 "web_visit_period_new_return_line.widget.xml", parameters, content_5, 
					 userSession, messages, null ); 
...
<form name="form1" action="web_master_overview_dashboard.jsp" method="GET">
