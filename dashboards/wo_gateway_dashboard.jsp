...
title = "Work Order Sample Dashboard for the " + temporal_cat + " " + temporal_value;
String WORK_ORDER_DATE = "";
StringBuffer content_period_vert_bar = new StringBuffer();
StringBuffer content_bu_vert_bar = new StringBuffer();
StringBuffer content_dept_vert_bar = new StringBuffer();
StringBuffer content_status_vert_bar = new StringBuffer();
StringBuffer content_product_vert_bar = new StringBuffer();
StringBuffer content_cust_country_vert_bar = new StringBuffer();
...
parameters.setParameter( "drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_time_cube.xaction" );
...
ChartHelper.doChart("breadboard", "supply_chain/work_orders/dashboards",
                    ...
                    content_period_vert_bar, userSession, messages, null);
...
parameters.setParameter("drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_bu_cube.xaction" );
...
// Make a bar chart showing the supervisor department
// create the parameters for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter("drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_employee_cube.xaction" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
// define the business_unit axis of the bar chart
...
//use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart("breadboard", "supply_chain/work_orders/dashboards",
                    "wo_period_supervisor_dept_vert_bar.widget.xml", parameters,
                    content_dept_vert_bar, userSession, messages, null );




// Make a bar chart showing the status
// create the parameters for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_time_cube.xaction" );
...
//use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart("breadboard", "supply_chain/work_orders/dashboards",
                    "wo_period_status_vert_bar.widget.xml", parameters,
                    content_status_vert_bar, userSession, messages, null );
...
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_cust_time_cube.xaction" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
// define the business_unit axis of the bar chart
...
//use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart("breadboard", "supply_chain/work_orders/dashboards",
                    "wo_period_cust_country_vert_bar.widget.xml", parameters,
                    content_cust_country_vert_bar, userSession, messages, null );



// Make a bar chart showing the product
// create the parameters for the bar chart
parameters = new SimpleParameterProvider();
// define the click url template
parameters.setParameter( "drill-url", "Pivot?solution=breadboard&path=supply_chain/work_orders/analysis&action=wo_product_cube.xaction" );
parameters.setParameter( "TEMPORAL_VALUE", temporal_value);
// define the business_unit axis of the bar chart
parameters.setParameter( "inner-param", "PRODUCT"); //$NON-NLS-1$ //$NON-NLS-2$
// set the width and the height
parameters.setParameter( "image-width", "400"); //$NON-NLS-1$ //$NON-NLS-2$
parameters.setParameter( "image-height", "300"); //$NON-NLS-1$ //$NON-NLS-2$
 messages = new ArrayList();
...
//use the chart definition in 'samples/dashboard/regions.widget.xml'
ChartHelper.doChart("breadboard", "supply_chain/work_orders/dashboards",
                    "wo_period_product_vert_bar.widget.xml", parameters,
                    content_product_vert_bar, userSession, messages, null );
...
<html>
<head>
<title>Breadboard BI Sample Work Order Gateway Dashboard</title>
...
<form name="form1" action="wo_gateway_dashboard.jsp" method="GET">
...
<!-- Top of 1 -->
<%= content_period_vert_bar.toString() %>
<!-- Bottom of 1 -->
<br/>
                </td>
<!-- Top #2 -->
...
<!-- Top of #4 -->
<td valign="top" style="width: 33%">
<%= content_status_vert_bar.toString() %>
</td>
<!-- BOTTOM 4 -->
<!-- Top of #5 -->
<td valign="top" style="width: 33%">
<%= content_cust_country_vert_bar.toString() %>
</td>
<td valign="top" style="width: 33%">
<%= content_product_vert_bar.toString() %>
</td>
<!-- Top of #6 -->
